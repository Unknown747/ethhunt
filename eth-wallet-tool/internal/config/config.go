...
type RPCConfig struct {
        ...
        EndpointsAuth []RPCEndpointAuth   `yaml:"endpoints_auth"` // URL dengan custom header (Infura, Alchemy, dll)
...
// RPCEndpointAuth adalah endpoint RPC dengan custom HTTP headers (untuk provider berbayar)
